...
@section("main")
    ...
    <link rel="stylesheet" href="{{asset('assets/css/phuong/main.css')}}"><div class="page-wrapper bg-gra-01 p-t-180 p-b-100 font-poppins">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route("register")}}" method="post">
                        ...
                        <div class="input-group">
                            <input class="input--style-3" type="text" value="{{old("name")}}" name="name" placeholder="Tên tài khoản">
                            @error("name")
                            <p class="text-danger">{{$message}}</p>
                            @enderror
                        </div>
                        <div class="input-group">
                            <input class="input--style-3" type="email" value="{{old("email")}}" placeholder="Email" name="email">
                            @error("email")
                            <p class="text-danger">{{$message}}</p>
                            @enderror
                        </div>
